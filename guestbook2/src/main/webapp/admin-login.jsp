...
<head>
    ...
    <style type="text/css">
        <!--
        .STYLE1 {
            font-family: "新宋体"; // 设置字体为新宋体
        font-size: medium; // 设置字体大小为中等
        }
        -->
    </style>
</head>
...
<form name="f" action="LoginServlet" method="post" onSubmit="return verify()"> <!-- 表单，提交到 LoginServlet，提交前进行验证 -->
    <input type="hidden" name="from" value="admin"/> <!-- 隐藏字段，表示来自管理员登录页面 -->
    ...
    <p align="center"><a href="login.jsp">普通用户登录</a></p> <!-- 链接到普通用户登录页面 -->
</form>
</body>
</html>
